...
class LicenseManager:
    ...
    def activate_with_key(self):
        ...
        while True:
            ...
            user_key = user_input.upper() if user_input != "phonganh" else user_input.lower()
...
def create_menu_table():
    ...
    modes = [
        ("1", "[#ffffff] TOOL [bold #00ffff]ADB[/] [#ffd54f]REG[/] [bold #38bdf8]APP[/] [bold #ff9ecb][/][bold #00ff9c]INSTAGRAM[/][bold #a78bfa] VIP[/]"),
    ]
...
# ===== DANH SÁCH LINK TOOL =====
RAW_LINKS = {
    "1": "https://raw.githubusercontent.com/Caoquy2k3/phong/refs/heads/main/regig.py",
}
    ...
    while True:
        ...
        while True:
            ...
            if choice in RAW_LINKS:
                ...
                input()
                # Sau khi chạy tool xong, kiểm tra lại license
                break
            else:
